        ...
        {myCards &&
          cards.map((card, index) => (
            <div className="group relative">
              ...
              {!sure && (
                <div>
                  <Link to={"/edit/" + card.id}>
                    <button
                      className="bg-gray-700 absolute rounded-lg text-white p-2 top-12 left-8  group-hover:opacity-70 opacity-0  hover:!bg-blue-700 hover:!opacity-90 "
                      onClick={() => {
              ...
              {sure && (
                <div>
                  <label className=" text-white bg-gradient-to-b from-black top-14 left-[120px] opacity-0 group-hover:opacity-70 absolute font-semibold">
                    Are you sure?
                  </label>
                  <button
                    className="bg-gray-700 rounded-lg z-20  text-white p-2 top-24 left-24   opacity-0 group-hover:opacity-80 absolute  hover:!bg-blue-700 hover:!opacity-90 "
                    onClick={() => setSure(false)}
                  >
                    ❌
                  </button>
                  <button
                    className="bg-gray-700 rounded-lg z-20  text-white p-2 top-24 right-24  opacity-0 group-hover:opacity-80 absolute  hover:!bg-red-700 hover:!opacity-90 "
